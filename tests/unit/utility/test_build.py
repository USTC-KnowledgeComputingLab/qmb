...
def test_build_model_valid() -> None:
    with (
        mock.patch("qmp.utility._build.model_config_dict", {"fake": _FakeConfig}),
        mock.patch("qmp.utility._build.model_dict", {"fake": _FakeImpl}),
    ):
...
def test_build_model_missing_name() -> None:
    with mock.patch("qmp.utility._build.model_config_dict", {}), mock.patch("qmp.utility._build.model_dict", {}):
